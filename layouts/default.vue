<template>
  <div class="flex h-screen">
    ...
    <div class="flex flex-1 flex-col overflow-y-auto">
      <div class="border-gray-9 max-md:shadow-sm sticky top-0 z-10 flex min-h-16 items-center justify-between border-b bg-white dark:border-gray-800 dark:bg-[#0F172A]">
